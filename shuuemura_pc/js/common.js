...
$(function () {
  ...
  // 해시태그 클릭시 창닫기
  $('#search_popup .search_wrap .search_box .tag a').click(function() {
    $('#search_popup').fadeOut(500);
    $('.popup_background').hide();
  })

  //롤링 텍스트 클릭하면 값 입력
  $('#search_popup .rolling li a').on('click',function (e) {
    e.preventDefault();
    var rollingText=$(this).text();
    $('#search').val(rollingText);
  })
